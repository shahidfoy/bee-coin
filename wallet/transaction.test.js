...
describe('Transaction', () => {
    let transaction, wallet, recipient, amount, largeAmount;
    ...
    it('invalidate a valid transaction', () => {
    ...
    describe('transacting with an amount that exceeds the balance', () => {
        beforeEach(() => {
            largeAmount = 50000;
            transaction = Transaction.newTransaction(wallet, recipient, largeAmount);
    ...
    describe('and updating a transaction', () => {
        ...
        it('substracts the next amount from the senders output', () => {
